...
'***    EXEMPLE:                                                                                        ***
'******************************************************************************
Public Function Arrondi(ByVal DblValeur As Currency, ByVal IntPrecision As Integer) As Currency

   On Error GoTo Err_Arrondi

   Arrondi = -Int(-(DblValeur * 10 ^ IntPrecision)) / 10 ^ IntPrecision
...
Err_Arrondi:
   ...
   MsgBox Err.Number & " " & Err.Description, , "Arrondi"
